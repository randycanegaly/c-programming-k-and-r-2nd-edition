...
/*modify the sort program to use a -f flag to fold upper and lower case
 * together so that a and A compare equal
 */
...
int main(int argc, char *argv[]) {
    ...
    int fold = 0; /*1 if lower and upper case sort the same */
